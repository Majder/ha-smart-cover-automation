...
ENTITY_CONFIGS = [
    ...
    {
        "id": "sun_azimuth_tolerance_start",
        "class": SunAzimuthToleranceStartNumber,
        "key": NUMBER_KEY_SUN_AZIMUTH_TOLERANCE_START,
        "config_key": ConfKeys.SUN_AZIMUTH_TOLERANCE_START.value,
    ...
    {
        "id": "sun_azimuth_tolerance_end",
        "class": SunAzimuthToleranceEndNumber,
        "key": NUMBER_KEY_SUN_AZIMUTH_TOLERANCE_END,
        "config_key": ConfKeys.SUN_AZIMUTH_TOLERANCE_END.value,
    ...
    {
        "id": "sun_elevation_max_lookahead_minutes",
        "id": "sun_elevation_max_hysteresis",
        "class": SunElevationMaxHysteresisNumber,
        "key": NUMBER_KEY_SUN_ELEVATION_MAX_HYSTERESIS,
        "config_key": ConfKeys.SUN_ELEVATION_MAX_HYSTERESIS.value,
    ...
    },
    {
        ...
        "config_key": ConfKeys.DAILY_MAX_TEMPERATURE_THRESHOLD.value,
    ...
    {
        "id": "daily_min_temperature_threshold",
        "class": DailyMinTemperatureThresholdNumber,
        "key": NUMBER_KEY_DAILY_MIN_TEMPERATURE_THRESHOLD,
        "config_key": ConfKeys.DAILY_MIN_TEMPERATURE_THRESHOLD.value,
